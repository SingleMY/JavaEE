                            ...
                            <div class="card-body">
                                ...
                                <form action="SubmitHomeworkServlet" method="post" class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <a type="submit" class="btn btn-primary" href="HomeworkSubmit.jsp?h_id=<%=request.getParameter("h_id")%>&title=<%=request.getParameter("title")%>&content=<%=request.getParameter("content")%>">去提交</a>
                                    </div>
                                </form>
